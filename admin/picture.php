<?php
    ...
    if (isset($_GET["image"]) && basename($_GET["image"]) == $_GET["image"]){
        ...
        $pic = filter_input(INPUT_GET, "name", FILTER_SANITIZE_STRING);
        getImage($pic_folder, $pic);
    }else{
    ...
    function getImage($pic_folder, $pic_name){
        // Absolute path to image folder
        $image_folder = '../uploads';
        $pic = $image_folder."/".$pic_folder."/".$pic_name;
